describe("resolve", function () {
    ...
    describe(".resolve()", function () {
        ...
        it("allows a function to depend on an injector value of the same name", function () {
            var r = $r.resolve({ $resolve: function ($resolve) {
                return $resolve === $r;
            } });
            tick();
        ...
        it("allows inheritance from a parent resolve()", function () {
            var r = $r.resolve({ fun: function () {
                return true;
            } });
            var s = $r.resolve({ games: function () {
                return true;
            } }, r);
            tick();
        ...
        it("propagates errors from a parent resolve", function () {
            ...
            var r = $r.resolve({ foo: function () {
                throw error
            } });
            var s = $r.resolve({ bar: function () {
                42
            } }, r);
            tick();
    ...
    describe(".study()", function () {
        ...
        it("returns a function that can be used multiple times", function () {
            var trace = [];
            var r = $r.study({ a: [ 'what', function (what) {
                trace.push("a: " + what)
            } ] });
            r({ what: '1' });

                ...
                return {
                    ...
                    compile: function (element, attr, transclude) {
                        ...
                        if (attr.hasSubheader == "true") {
                            element.addClass('has-subheader');
                        }
                        ...
                        if (attr.padding == "true") {
                            element.find('div').addClass('padding');
                        }
 ...
 */
    ...
    .directive('ionTabs', ['$ionicViewService', '$ionicBind', '$parse', function ($ionicViewService, $ionicBind, $parse) {
        return {
            ...
            transclude: true,
            controller: 'ionicTabs',
            template: '<div class="view {{$animation}}">' +
 ...
 */
    ...
    .directive('ionTabNav', ['$ionicNgClick', function ($ionicNgClick) {
        return {
            ...
            replace: true,
            require: ['^ionTabs', '^ionTab'],
            template: '<a ng-class="{active: isTabActive(), \'has-badge\':badge}" ' +
                ' class="tab-item">' +
        ...
        .directive('ionNavBar', ['$ionicViewService', '$rootScope', '$animate', '$compile',
            function ($ionicViewService, $rootScope, $animate, $compile) {
                ...
                return {
                    ...
                    template: '<header class="bar bar-header nav-bar{{navBarClass()}}">' +
        ...
        .directive('ionNavBackButton', ['$ionicViewService', '$rootScope',
            function ($ionicViewService, $rootScope) {
                ...
                return {
                    ...
                    replace: true,
                    template: '<button ng-click="goBack($event)" class="button back-button {{type}} ' +
 ...
 * });
     ...
     * and then try to load homePartial.html into the `<ion-nav-view>`.
     *
     * Pages are loaded by the URLs given. One simple way to create templates in Angular is to put
     * them directly into your HTML file and use the `<script type="text/ng-template">` syntax.
     * So here is one way to put homePartial.html into our app:
     *
     * ```html
